...
result_hello=$(ros2 topic echo -t std_msgs/String/translation_topic --once | grep -o 'Hello')
...
result_thanks=$(ros2 topic echo -t std_msgs/String/translation_topic --once | grep -o 'Thank you')
...
result_goodbye=$(ros2 topic echo -t std_msgs/String/translation_topic --once | grep -o 'Goodbye')
...
result_dog=$(ros2 topic echo -t std_msgs/String/translation_topic --once | grep -o 'Dog')
...
result_cat=$(ros2 topic echo -t std_msgs/String/translation_topic --once | grep -o 'Cat')
...
result_unknown=$(ros2 topic echo -t std_msgs/String/translation_topic --once | grep -o 'Unknown')
